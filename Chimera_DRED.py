...
import os
import winsound
from help_chimera import help_window
...
# logo
img = tk.PhotoImage(file=r".\button_decals\MediumLogo.GIF")
...
addphoto = tk.PhotoImage(file=r".\button_decals\add_image.png")
remphoto = tk.PhotoImage(file=r".\button_decals\remove_image.png")
playphoto = tk.PhotoImage(file=r".\button_decals\play_image.png")
helpphoto = tk.PhotoImage(file=r".\button_decals\help_image.png")
initphoto = tk.PhotoImage(file=r".\button_decals\init_image.png")
timephoto = tk.PhotoImage(file=r".\button_decals\time_image.png")
clearphoto = tk.PhotoImage(file=r".\button_decals\clear_image.png")
vncphoto = tk.PhotoImage(file=r".\button_decals\vnc_image.png")
resetphoto = tk.PhotoImage(file=r".\button_decals\reset_image.png")
showphoto = tk.PhotoImage(file=r".\button_decals\show_image.png")
shutdownphoto = tk.PhotoImage(file=r".\button_decals\shutdown_image.png")
coordphoto = tk.PhotoImage(file=r".\button_decals\coord_image.png")
...
def scan_iplist():
    scanips = []
    with open(r'.\reference\dredlist.csv') as iplist_csv:
...
def playlocal_script(freq):
    ...
    # print("ufreq = " + ufreq)
    # pyscript = ufreq
    cmd = ['C:\\Users\\falcon\\Documents\\OpenSSH\\sftp.exe ',
           'pi@' + targetip + ':/home/pi/Music/' + get_soundb + '.wav', ' got.wav ; exit']
    print(cmd)
    conout = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE).communicate()
